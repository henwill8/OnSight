...
interface Props {
  ...
  enablePan?: boolean;  // Enable or disable pan gesture
  enableRotate?: boolean;  // Enable or disable rotate gesture
  enableZoom?: boolean;  // Enable or disable zoom gesture
}
...
const PanRotateZoomView = forwardRef<PanRotateZoomViewRef, Props>(
  ({ children, enablePan = true, enableRotate = true, enableZoom = true }, ref) => {
      ...
      PanResponder.create({
        ...
        onPanResponderMove: (event) => {
          ...
          if (touches.length === 2) {
            ...
            // Handle zoom (scaling)
            if (enableZoom && lastDistance.current !== null) {
            ...
            if (enablePan && lastTranslateX.current !== null && lastTranslateY.current !== null) {
